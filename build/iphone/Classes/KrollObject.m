 ...
 * Copyright (c) 2009-2011 by iFeelKid, Inc. All Rights Reserved.
...
//@interface iFeelKidObject : NSObject
//@end

@interface iFeelKidObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[iFeelKidObject class]])
		{
			for (NSString *key in [[(iFeelKidObject*)o modules] allKeys])
			{
