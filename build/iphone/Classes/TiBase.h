...
// in simulator we redefine to format for iFeelKid Developer console
...
{\
	NSString * exceptionName = [@"org.ifeelkid." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.ifeelkid";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	TiExceptionThrowWithNameAndReason(exceptionName,message);\
}\
...
enum {
	UIiFeelKidNativeItemNone = -1, 
	UIiFeelKidNativeItemSpinner = -2,
	UIiFeelKidNativeItemProgressBar = -3,
	
	UIiFeelKidNativeItemSlider = -4,
	UIiFeelKidNativeItemSwitch = -5,
	UIiFeelKidNativeItemMultiButton = -6,
	UIiFeelKidNativeItemSegmented = -7,
	
	UIiFeelKidNativeItemTextView = -8,
	UIiFeelKidNativeItemTextField = -9,
	UIiFeelKidNativeItemSearchBar = -10,
	
	UIiFeelKidNativeItemPicker = -11,
	UIiFeelKidNativeItemDatePicker = -12,
	
	UIiFeelKidNativeItemInfoLight = -13,
	UIiFeelKidNativeItemInfoDark = -14,
	
	UIiFeelKidNativeItemDisclosure = -15,
	
	UIiFeelKidNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all iFeelKid instances of
